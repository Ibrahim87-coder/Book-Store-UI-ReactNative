...
import { SafeAreaView, StyleSheet, Text, TouchableOpacity,ScrollView,FlatList, View ,Image} from 'react-native'
import { COLORS, FONTS, icons, SIZES,images } from '../constants'


const LineDivider = () => {
    return (
        <View style={{ width: 1, paddingVertical: 16 }}>
            ...
            <View style={{flex:1,flexDirection:'row',paddingHorizontal:SIZES.padding,alignItems:'center'}}>
                ...
                >
                    <View style={{flex:1, flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                        <View style={{width:23,height:23,alignItems:'center',justifyContent:'center',borderRadius:25,backgroundColor:'rgba(0,0,0,0.5)'}}>
                            <Image
                ...
                <View style={{ flexDirection:'row', height:70, backgroundColor: COLORS.secondary, borderRadius: SIZES.radius}}>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body4, color: COLORS.white }}>Get Point</Text>
                        </View>
                    </TouchableOpacity>
                    {/* Divider  */}
                    <LineDivider />
                ...
                <View style={{ marginVertical: SIZES.base }}>
                    ...
                    >
                        ...
                        <View style={{ flex: 1, marginLeft: SIZES.radius }}>
                            ...
                            {/* Genre */}
                            <ScrollView horizontal style={{ flexDirection: 'row',flexWrap:'wrap', marginTop: SIZES.base }}>
                                {
